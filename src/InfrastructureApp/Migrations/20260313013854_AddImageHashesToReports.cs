...
{
    /// <inheritdoc />
    public partial class AddImageHashesToReports : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImagePHash = table.Column<long>(type: "bigint", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reports_UserId_ImageSha256",
                table: "Reports",
                columns: new[] { "UserId", "ImageSha256" });
